...
const handleSettignsClick = (tier) => {
    activeTier = tier;
...
const handleDrop = (event) => {
    event.preventDefault(); //allow default browser default
};
...
const createTier = (label = "Change me") => {
    ...
    .addEventListener("click", () => handleSettignsClick(tier));
...
const initDefaultTierList = (params) => {
    ['S', 'A', 'B', 'C', 'D', 'E', 'F'].forEach((label) =>{
